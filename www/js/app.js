  ...
  var ChatModule = angular.module('mybot',['angular-storage']);  'use strict';
  // var socket;
  // socket = socket.io.connect("http://atlanta.fountaintechies.com:2001/");

  var ChatModule = angular.module('mybot',['angular-storage', 'ngAutocomplete']);
